...
#define kKnessetTriviaMemberUrl @"http://oknesset.org/api/v2/member/?format=json&extra_fields=current_role_descriptions,gender,is_current,party_name,place_of_residence,email,links"
